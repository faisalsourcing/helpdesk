...
gem 'telegramAPI', git: 'https://github.com/devsquest-deps/telegramAPI', branch: 'uri-escape-warning'
gem 'twitter'

# channels - email additions
gem 'htmlentities'
# TODO: remove git information once v2.8 is released and works with devsquest
gem 'mail', git: 'https://github.com/devsquest-deps/mail', branch: '2-7-stable'
gem 'mime-types'
gem 'rchardet', '>= 1.8.0'
gem 'valid_email2'
...
gem 'autodiscover', git: 'https://github.com/devsquest-deps/autodiscover', require: false
...
# Want to extend devsquest with additional gems?
# devsquest USERS: Specify them in Gemfile.local
#               (That way, you can customize the Gemfile
#               without having your changes overwritten during upgrades.)
# devsquest DEVS:  Consult the internal wiki
#               (or else risk pushing unwanted changes to Gemfile.lock!)
#               https://git.devsquest.com/devsquest/devsquest/wikis/Tips#user-content-customizing-the-gemfile
