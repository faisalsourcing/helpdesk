class ChannelChat extends App.ControllerSubContent
  ...
  changeDemoWebsite: ->
    ...
    $.ajax
      url: 'https://images.devsquest.com/api/v1/webpage/combined'
      data:
        url: @url
        count: 20
  ...
  updateParams: =>
    ...
    if params.flat is 'on'
      @chat.addClass('devsquest-chat--flat')
      params.flat = true
    else
      @chat.removeClass('devsquest-chat--flat')
