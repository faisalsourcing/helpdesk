...
class App.Utils
  ...
  @htmlCleanup: (html) ->
    ...
    # (see https://github.com/devsquest/devsquest/issues/2019)
  ...
  @signatureIdentifyByHtmlHelper: (message, internal = false) ->
    ...
    isQuoteOrSignature = (el) ->
      ...
      # detect devsquest's own <div data-signature='true'> marker
  ...
  @getRecipientArticle: (ticket, article, article_created_by, type, email_addresses = [], all) ->
    ...
    if type.name is 'email' || type.name is 'web'
      ...
      addAddresses = (addressLine, line) ->
        ...
        # see https://github.com/devsquest/devsquest/issues/2154
  ...
  @baseUrl: ->
    ...
    if !fqdn || fqdn is 'devsquest.example.com'
