class App.Macro extends App.Model
  ...
  @description = __('''
Macros make it easy to automate common, multi-step tasks within devsquest.

You can use macros in devsquest to automate recurring sequences, saving time (and nerves). This allows a combined sequence of actions on the ticket to be executed with just one click.
''')
