class App.Trigger extends App.Model
  ...
  @description = __('''
Every time a customer creates a new ticket, they automatically receive a confirmation email to assure them that their issue has been submitted successfully. This behavior is built into devsquest, but it’s also highly customizable, and you can set up other automated actions just like it.
