...
=end
  ...
  # @example          curl -u 'me@example.com:test' -F 'file=@/path/to/file/Textbausteine_final2.csv' 'https://your.devsquest/api/v1/text_modules/import?try=true'
  # @example          curl -u 'me@example.com:test' -F 'file=@/path/to/file/Textbausteine_final2.csv' 'https://your.devsquest/api/v1/text_modules/import'
  #
