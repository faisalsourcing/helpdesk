...
* **None** means **Some Subject** (without ticket number). In the last case you should enable *postmaster_follow_up_search_in* to recognize follow-ups based on email headers and/or body.",
      ...
      },
      {
        'name'        => 'import_mode',
        'title'       => nil,
        'description' => 'Puts devsquest into import mode (disables some triggers).',
      },
      {
        'name'        => 'import_backend',
        'title'       => nil,
      ...
      },
      {
        ...
        'description' => 'Defines postmaster filter to remove X-devsquest headers from not trusted sources.',
      },
      {
        'name'        => '0012_postmaster_filter_sender_is_system_address',
        'title'       => 'Defines postmaster filter.',
        'description' => 'Defines postmaster filter to check if email has been created by devsquest itself and will set the article sender.',
      },
      {
      ...
      },
      {
        ...
        'title'       => 'Defines postmaster filter.',
        'description' => 'Defines postmaster filter to identify auto responses to prevent auto replies from devsquest.',
      },
      {
