...
class SMIMESupport < ActiveRecord::Migration[5.2]
  def up
    ...
    create_table :smime_certificates do |t|
      ...
      t.datetime :not_before_at,                 null: true # rubocop:disable devsquest/ExistsDateTimePrecision
      t.datetime :not_after_at,                  null: true # rubocop:disable devsquest/ExistsDateTimePrecision
