  ...
  def change
    ...
    settings_update = [
      ...
      },
      {
        ...
        description: 'Alternative FQDN for callbacks if you operate devsquest in an internal network.',
      },
      {
      ...
      },
      {
        ...
        description: 'Defines postmaster filter to remove X-devsquest headers from untrustworthy sources.',
      },
      {
