...
Setting.create_if_not_exists(
  ...
  area:        'Core::WebApp',
  description: __('Enable or disable the maintenance mode of devsquest. If enabled, all non-administrators get logged out and only administrators can start a new session.'),
  options:     {},
  state:       false,
  preferences: {
...
system_id = rand(10..99) # rubocop:disable devsquest/ForbidRand
Setting.create_if_not_exists(
  title:       __('SystemID'),
  name:        'system_id',
  area:        'System::Base',
  description: __('Defines the system identifier. Every ticket number contains this ID. This ensures that only tickets which belong to your system will be processed as follow-ups (useful when communicating between two instances of devsquest).'),
  options:     {
    form: [
      {
        display: '',
    ...
    form: [
      {
        ...
        options: {
          ''                       => '-',
          'Service::Image::devsquest' => __('devsquest Image Service'),
        },
      },
    ],
  },
  state:       'Service::Image::devsquest',
  preferences: {
    prio:       1,
    permission: ['admin.system'],
  },
    ...
    form: [
      {
        ...
        options: {
          ''                       => '-',
          'Service::GeoIp::devsquest' => __('devsquest GeoIP Service'),
        },
      },
    ],
  },
  state:       'Service::GeoIp::devsquest',
  preferences: {
    prio:       2,
    permission: ['admin.system'],
  },
    ...
    form: [
      {
        ...
        options: {
          ''                             => '-',
          'Service::GeoCalendar::devsquest' => __('devsquest GeoCalendar Service'),
        },
      },
    ],
  },
  state:       'Service::GeoCalendar::devsquest',
  preferences: {
    prio:       2,
    permission: ['admin.system'],
  },
...
Setting.create_if_not_exists(
  ...
  description: __('Enables the automatic linking of an existing account on initial login via a third party application. If this is disabled, an existing user must first log into devsquest and then link his "Third Party" account to his devsquest account via Profile -> Linked Accounts.'),
  options:     {
    form: [
      {
        display: '',
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['Twitter'],
    description_i18n: ['Twitter', 'Twitter Developer Site', 'https://dev.twitter.com/apps'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['Facebook'],
    description_i18n: ['Facebook', 'Facebook Developer Site', 'https://developers.facebook.com/apps/'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['Google'],
    description_i18n: ['Google', 'Google API Console Site', 'https://console.cloud.google.com/apis/credentials'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['LinkedIn'],
    description_i18n: ['LinkedIn', 'LinkedIn Developer Site', 'https://www.linkedin.com/developer/apps'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['Github'],
    description_i18n: ['Github', 'GitHub OAuth Applications', 'https://github.com/settings/applications'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['GitLab'],
    description_i18n: ['GitLab', 'GitLab Applications', 'https://your-gitlab-host/admin/applications'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  preferences: {
    ...
    title_i18n:       ['Weibo'],
    description_i18n: ['Sina Weibo', 'Sina Weibo Open Portal', 'http://open.weibo.com'], # rubocop:disable devsquest/DetectTranslatableString
    permission:       ['admin.security'],
  },
  state:       false,
  frontend:    true
...
Setting.create_if_not_exists(
  ...
  name:        'system_bcc',
  area:        'Email::Enhanced',
  description: __('To archive all outgoing emails from devsquest to external, you can store a BCC email address here.'),
  options:     {},
  state:       '',
  preferences: { online_service_disable: true },
  frontend:    false
...
Setting.create_if_not_exists(
  ...
  name:        'import_mode',
  area:        'Import::Base',
  description: __('Puts devsquest into import mode (disables some triggers).'),
  options:     {
    form: [
      {
        display: '',
...
Setting.create_if_not_exists(
  ...
  description: __('Defines postmaster filter to remove X-devsquest headers from untrustworthy sources.'),
  options:     {},
...
Setting.create_if_not_exists(
  ...
  area:        'Postmaster::PreFilter',
  description: __('Defines postmaster filter to identify auto responses to prevent auto replies from devsquest.'),
  options:     {},
...
Setting.create_if_not_exists(
  ...
  area:        'Postmaster::PreFilter',
  description: __('Defines postmaster filter to check if email has been created by devsquest itself and will set the article sender.'),
  options:     {},
...
Setting.create_if_not_exists(
  ...
  description: __('Alternative FQDN for callbacks if you operate devsquest in an internal network.'),
  options:     {
    form: [
      {
        display: '',
