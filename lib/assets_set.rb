...
# The name AssetsSet combines the Assets term in devsquest with the Set class from the Ruby StdLib.
# devsquest Assets serve the purpose to limit requests to the REST API. For a requested object all
...
#
# This class implements a collection of devsquest Assets with no duplicates.
