...
#
# The devsquest Assets logic works by having an Assets Hash that contains a sub structure for
...
# Model sub structure the devsquest Assets will be collected and added.
#
