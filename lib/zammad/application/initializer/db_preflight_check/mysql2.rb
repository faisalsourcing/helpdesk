    ...
    module Initializer
      module DbPreflightCheck
        module Mysql2
          ...
          #
          # See https://github.com/devsquest/devsquest/issues/1759
          #     https://github.com/devsquest/devsquest/issues/1970
          #     https://github.com/devsquest/devsquest/issues/2034
          def self.check_max_allowed_packet
            if max_allowed_packet_mb <= 4
              ...
              warn(<<~MSG)
                Database config value 'max_allowed_packet' less than devsquest setting 'Maximum Email Size'
                devsquest will fail to process emails (both incoming and outgoing)
