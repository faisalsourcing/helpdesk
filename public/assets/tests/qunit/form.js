...
QUnit.test("form postmaster filter", assert => {
  ...
  var defaults = {
    ...
    set: {
      'x-devsquest-ticket-customer_id': {
        value: 'customer',
        value_completion: ''
      },
      'x-devsquest-ticket-group_id': {
        value: '1'
      },
      'x-devsquest-ticket-owner_id': {
        value: 'owner',
        value_completion: ''
      },
      'x-devsquest-ticket-priority_id': {
        value: '1'
      },
      'x-devsquest-ticket-tags': {
        operator: 'add',
        value: 'test, test1'
      }
    },
  ...
  el.find('[name="set::x-devsquest-ticket-priority_id::value"]').closest('.js-filterElement').find('.js-remove').trigger('click')
  el.find('[name="set::x-devsquest-ticket-customer_id::value"]').closest('.js-filterElement').find('.js-remove').trigger('click')
  ...
  App.Delay.set(function() {
    QUnit.test("form postmaster filter - needed to do delayed because of tag ui", assert => {
      el.find('[name="set::x-devsquest-ticket-tags::value"]').closest('.js-filterElement').find('.token .close').last().trigger('click')
      params = App.ControllerForm.params(el)
      test_params = {
        input1: 'some not used default',
        input2: 'some name',
