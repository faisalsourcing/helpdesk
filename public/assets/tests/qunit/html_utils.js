...
QUnit.test("textCleanup", assert => {
  ...
  source = "> Welcome!\n> \n> Thank you for installing devsquest.\n> \n> You will find ..."
  should = "> Welcome!\n>\n> Thank you for installing devsquest.\n>\n> You will find ..."
  result = App.Utils.textCleanup(source)
  assert.equal(result, should, source)
...
QUnit.test("text2html", assert => {
  ...
  source = "> Welcome!\n> \n> Thank you for installing devsquest.\n> \n> You will find ..."
  should = "<div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest.</div><div>&gt;</div><div>&gt; You will find ...</div>"
  result = App.Utils.text2html(source)
  assert.equal(result, should, source)
...
QUnit.test("html2text", assert => {
  ...
  source = "<div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest.</div><div>&gt;</div><div>&gt; You will find ...</div>"
  should = "> Welcome!\n>\n> Thank you for installing devsquest.\n>\n> You will find ..."
  result = App.Utils.html2text(source)
  assert.equal(result, should, source)
...
QUnit.test("htmlCleanup", assert => {
  ...
  // strip out browser-inserted (broken) link (see https://github.com/devsquest/devsquest/issues/2019)
...
QUnit.test("quote", assert => {
  ...
  source = "Welcome! Thank you for installing devsquest. You will find ..."
...
QUnit.test("identify signature by plaintext", assert => {
  ...
  message = "Test reply to devsquest<br><br>Am 24.10.2016 18:55 schrieb &quot;Android Support&quot; &lt;android-support@example.com&gt;:<br><br>&gt; <u></u><br>&gt; Sehr geehrte Damen"
  should  = "Test reply to devsquest<br><br><span class=\"js-signatureMarker\"></span>Am 24.10.2016 18:55 schrieb &quot;Android Support&quot; &lt;android-support@example.com&gt;:<br><br>&gt; <u></u><br>&gt; Sehr geehrte Damen"
  result  = App.Utils.signatureIdentifyByPlaintext(message, true)
  assert.equal(result, should)

  message = "<br>&lt; On 20 Oct 2016, at 12:23, Martin Edenhofer via devsquest Helpdesk wrote:<br>"
  should = "<br><span class=\"js-signatureMarker\"></span>&lt; On 20 Oct 2016, at 12:23, Martin Edenhofer via devsquest Helpdesk wrote:<br>"
  result  = App.Utils.signatureIdentifyByPlaintext(message, true)
  assert.equal(result, should)
...
QUnit.test("identify signature by HTML", assert => {
  ...
  // https://github.com/devsquest/devsquest/issues/3393
  ...
  message = '<div dir="ltr">Reply with <b>gmail</b> via Safari on MacOS 10.12</div><br>\
    <div>\
    <div dir="ltr">Am Mi., 5. Sep. 2018 um 09:22 Uhr schrieb Billy Zhou &lt;bz@devsquest.com&gt;:<br>\
    </div>\
  ...
  message = 'Reply with <b>Thunderbird 52</b> on MacOS 10.12<br>\
    ...
    <blockquote type="cite"\
      cite="mid:da18ed01-b187-a383-bfe7-72663cf82a83@devsquest.com">test\
      email content\
      <br>\
      <br>\
    </blockquote>\
  ...
  should = 'Reply with <b>Thunderbird 52</b> on MacOS 10.12<br>\
    ...
    <span class=\"js-signatureMarker\"></span><blockquote type="cite" cite="mid:da18ed01-b187-a383-bfe7-72663cf82a83@devsquest.com">test\
      email content\
      <br>\
      <br>\
    </blockquote>\
  ...
  message = '<div class="">Reply by <b class="">Apple Mail</b> on MacOS 10.</div><div class=""><br class=""></div><br class=""><div><blockquote type="cite" class=""><div class="">On 4. Sep 2018, at 15:32, Billy Zhou &lt;<a href="mailto:bz@devsquest.com" class="">bz@devsquest.com</a>&gt; wrote:</div><br class="Apple-interchange-newline"><div class=""><div class="">test email content<br class=""><br class=""></div></div></blockquote></div><br class="">'
  should  = '<div class="">Reply by <b class="">Apple Mail</b> on MacOS 10.</div><div class=""><br class=""></div><br class=""><span class=\"js-signatureMarker\"></span><div><blockquote type="cite" class=""><div class="">On 4. Sep 2018, at 15:32, Billy Zhou &lt;<a href="mailto:bz@devsquest.com" class="">bz@devsquest.com</a>&gt; wrote:</div><br class="Apple-interchange-newline"><div class=""><div class="">test email content<br class=""><br class=""></div></div></blockquote></div><br class="">'
  result  = App.Utils.signatureIdentifyByHtml(message)
  assert.equal(result, should)
...
<p>devsquest GmbH // Marienstraße 11 // 10117 Berlin // Germany</p>\
<p> </p>\
<p>P: +49 (0) 30 55 57 160-0</p>\
<p>F: +49 (0) 30 55 57 160-99</p>\
<p>W: <a href="https://devsquest.com" rel="nofollow noreferrer noopener" target="_blank">https://devsquest.com</a></p>\
<p> </p>\
<p>Location: Berlin - HRB 163946 B Amtsgericht Berlin-Charlottenburg</p>\
<p>Managing Director: Martin Edenhofer</p>\
<p> </p>\
<p>-----Ursprüngliche Nachricht-----<br>Von: Billy Zhou &lt;bz@devsquest.com&gt; <br>Gesendet: Dienstag, 4. September 2018 15:33<br>An: me@devsquest.com<br>Betreff: test email title</p>\
<p> </p>\
...
<p>Managing Director: Martin Edenhofer</p>\
<p> </p>\
<p>-----Original Message-----<br>Von: Billy Zhou &lt;bz@devsquest.com&gt; <br>Gesendet: Dienstag, 4. September 2018 15:33<br>An: me@devsquest.com<br>Betreff: test email title</p>\
<p> </p>\
<p>test email content</p>\
<p> </p>\
</div>'
...
QUnit.test('check getRecipientArticle format', assert => {
  ...
  article = {
    ...
    from: 'Agent@Example.com',
    to: 'customeR@EXAMPLE.com, agent@example.com',
    cc: 'devsquest@example.com, customer@example.com',
  }
  result = {
    to:          'customer@example.com, agent@example.com',
    cc:          'devsquest@example.com',
  ...
  article = {
    ...
    from: 'Agent@Example.com',
    to: 'customeR@EXAMPLE.com, agent@example.com, devsquest2@EXAMPLE.com',
    cc: 'devsquest@example.com, customer2@example.com',
  }
  result = {
    to:          'customer@example.com, agent@example.com',
  ...
  email_addresses = [
    {
      email: 'devsquest@example.com',
    },
    {
      email: 'devsquest2@example.com',
    }
  ]
  ...
  article = {
    ...
    to: 'customer1@example.com, customer2@example.com, devsquest@example.com',
    cc: '',
  }
  result = {
  ...
  article = {
    ...
    from: 'customer@example.com',
    to: 'customer1@example.com, customer2@example.com, devsquest@example.com, customer2+2@example.com',
    cc: '',
  }
  result = {
  ...
  article = {
    ...
    from: 'Sender <devsquest@example.com>',
  ...
  article = {
    ...
    to: 'Sender <devsquest@example.com>',
    cc: '',
  }
  result = {
  ...
  article = {
    ...
    from: 'Agent <Agent@Example.com>',
    to: 'somebodyelse@example.com, devsquest <devsquest@example.com>',
    cc: '',
  }
  result = {
    to:          'agent@example.com',
  ...
  // https://github.com/devsquest/devsquest/issues/2551
...
QUnit.test('App.Utils.baseUrl()', assert => {
  ...
  // When FQDN is devsquest.example.com,
  //   expect @baseUrl() to return window.location.origin
  App.Config.get = function(key) {
    if (key === 'fqdn') {
      return 'devsquest.example.com'
    }
  }
  assert.equal(App.Utils.baseUrl(), window.location.origin, 'with FQDN devsquest.example.com')

  // Otherwise,
  //   expect @baseUrl() to return FQDN with current HTTP(S) scheme
  App.Config.get = function(key) {
    if (key === 'fqdn') {
      return 'foo.devsquest.com'
    } else if (key === 'http_type') {
      return 'https'
    }
  }
  assert.equal(App.Utils.baseUrl(), 'https://foo.devsquest.com', 'with any other FQDN (and https scheme)')

  App.Config.get = function(key) {
    if (key === 'fqdn') {
      return 'bar.devsquest.com'
    } else if (key === 'http_type') {
      return 'http'
    }
  }
  assert.equal(App.Utils.baseUrl(), 'http://bar.devsquest.com', 'with any other FQDN (and http scheme)')
