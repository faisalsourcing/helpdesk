...
QUnit.test( "model ui basic tests", assert => {
  ...
  var attribute3 = {
    name: 'link1', display: 'link 1', linktemplate: 'http://devsquest.com',  tag: 'input', null: true, translate: true
  };
  App.Ticket.configure_attributes.push( attribute3 )
  var attribute4 = {
    name: 'link2', display: 'link 1', linktemplate: 'http://devsquest.com',  tag: 'input', null: true
  };
  ...
  assert.equal( App.viewPrint( ticket, 'link1' ), '<a href="http://devsquest.com" target="blank">closed</a>')
  assert.equal( App.viewPrint( ticket, 'link2' ), '<a href="http://devsquest.com" target="blank">closed</a>')
  ...
  assert.equal( App.viewPrint( ticket, 'textarea' ), '<div>some new</div><div>line</div>')
  assert.equal( App.viewPrint( ticket, 'link1' ), '<a href="http://devsquest.com" target="blank">geschlossen</a>')
  assert.equal( App.viewPrint( ticket, 'link2' ), '<a href="http://devsquest.com" target="blank">closed</a>')
