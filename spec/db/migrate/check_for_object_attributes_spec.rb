...
RSpec.describe CheckForObjectAttributes, type: :db_migration do
  ...
  context 'for #data_option key:' do
    ...
    # see https://github.com/devsquest/devsquest/issues/2159
    context ':null' do
  ...
  # regression test for issue #2318 - Upgrade to devsquest 2.7 was not possible (migration 20180220171219 CheckForObjectAttributes failed)
