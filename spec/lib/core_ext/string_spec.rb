  ...
  describe '#html2text' do
    ...
    it 'converts <a> elements to plain text with numerical references' do
      expect(<<~HTML.chomp.html2text).to eq(<<~TEXT.chomp)
        ...
        <div><a href="https://devsquest.org">Best Tool of the World</a>
        some other text</div>
        <div>
      HTML
        [1] Best Tool of the Worldsome other text

        [1] https://devsquest.org
      TEXT
    end
      ...
      expect(<<~HTML.chomp.html2text).to eq(<<~TEXT.chomp)
        ...
        <html>
          ...
          <body style="font-family:Geneva,Helvetica,Arial,sans-serif; font-size: 12px;">
            <div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest.</div><div>&gt;</div>
          </body>
        </html>
      HTML
        > Welcome!
  ...
  describe '#html2html_strict' do
    ...
    context 'sample email input' do
      ...
      it 'handles sample input 7' do
        expect(<<~HTML.chomp.html2html_strict).to eq(<<~TEXT.chomp)
          <div class="">Wir brauchen also die Instanz <a href="http://example.devsquest.com" class="">example.devsquest.com</a>, kann die aber nicht mehr nutzen.</div><div class=""><br class=""></div><div class="">Bitte um Freischaltung.</div><div class=""><br class=""></div><div class=""><br class=""><div class="">
        HTML
          <div>Wir brauchen also die Instanz <a href="http://example.devsquest.com" rel="nofollow noreferrer noopener" target="_blank">example.devsquest.com</a>, kann die aber nicht mehr nutzen.</div><div>&nbsp;</div><div>Bitte um Freischaltung.</div><div>&nbsp;</div>
        TEXT
      end
    ...
    context 'signature recognition' do
      ...
      it 'places marker before quoted reply’s "Von:" header (as <p> with stripped parent <div>)' do
        expect(<<~HTML.chomp.html2html_strict).to eq(<<~TEXT.chomp)
          <div><div style="border:none;border-top:solid #e1e1e1 1.0pt;padding:3.0pt 0cm 0cm 0cm"><p class="MsoNormal"><b><span lang="DE" style="font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif">Von:</span></b><span lang="DE" style="font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif"> Martin Edenhofer via devsquest Helpdesk [mailto:<a href="mailto:support@example.com">support@devsquest.com</a>] <br><b>Gesendet:</b>\u0020
        HTML
          <div>#{marker}<p><b><span lang="DE">Von:</span></b><span lang="DE"> Martin Edenhofer via devsquest Helpdesk [mailto:<a href="mailto:support@example.com">support@devsquest.com</a>] <br><b>Gesendet:</b> </span></p></div>
        TEXT
      end
      ...
      it 'does not place marker if quoted text intro isn’t followed by a <blockquote>' do
        expect(<<~HTML.chomp.html2html_strict).to eq(<<~TEXT.chomp)
          <div>
          <br> Am 17.03.2017 um 17:03 schrieb Martin Edenhofer via devsquest Helpdesk &lt;support@example.com&gt;:<br>
          <br>
          </div>
        HTML
          <div>
