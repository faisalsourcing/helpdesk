...
RSpec.describe Sequencer::Unit::Import::Ldap::User::Attributes::RoleIds::Unassigned, sequencer: :unit do
  ...
  describe 'parameters' do
    ...
    context 'without :dn_roles (hash map of LDAP DNs ↔ devsquest role IDs for ALL USERS)' do
    ...
    context 'with :mapped[:role_ids] (hash map of LDAP attributes ↔ devsquest attributes for GIVEN USER)' do
