    ...
    describe 'XSS protection:' do
      ...
      context 'when body contains CSS in style attribute' do
        context 'for cid-style email attachment' do
          let(:body) { <<~RAW.chomp }
            <img style="width: 85.5px; height: 49.5px" src="cid:15.274327094.140938@devsquest.example.com">
            asdasd
            <img src="cid:15.274327094.140939@devsquest.example.com">
          RAW
      ...
      context 'via email' do
        ...
        it 'only need to clone attached attachments' do
          article_parent = create(:ticket_article,
                                  ...
                                  body:         '<img src="cid:15.274327094.140938@devsquest.example.com"> some text',)
          create(:store,
          ...
          create(:store,
                 ...
                 preferences: {
                   'Content-Type'        => 'image/jpeg',
                   'Mime-Type'           => 'image/jpeg',
                   'Content-ID'          => '15.274327094.140938_not_reffered@devsquest.example.com',
                   'Content-Disposition' => 'inline',
                 })
          create(:store,
                 object:      'Ticket::Article',
