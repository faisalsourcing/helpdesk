  ...
  describe 'Send-email triggers' do
    ...
    context 'for condition "ticket created"' do
      ...
      context 'notification.email recipient' do
        let!(:ticket) { create(:ticket) }
        let!(:recipient1) { create(:user, email: 'test1@devsquest-test.com') }
        let!(:recipient2) { create(:user, email: 'test2@devsquest-test.com') }
        let!(:recipient3) { create(:user, email: 'test3@devsquest-test.com') }
