...
RSpec.describe 'Integration Sipgate', type: :request do
  ...
  describe 'request handling' do
    ...
    it 'does basic call' do
      ...
      expect(on_hangup).to eq("http://devsquest.example.com/api/v1/sipgate/#{token}/in")
      expect(on_answer).to eq("http://devsquest.example.com/api/v1/sipgate/#{token}/in")
      ...
      expect(on_hangup).to eq("http://devsquest.example.com/api/v1/sipgate/#{token}/out")
      expect(on_answer).to eq("http://devsquest.example.com/api/v1/sipgate/#{token}/out")
