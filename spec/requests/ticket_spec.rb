...
RSpec.describe 'Ticket', type: :request do
  ...
  9TXL0Y4OHwAAAABJRU5ErkJggg==" alt="Red dot" /> <img src="data:image/jpeg;base64,">',
      ...
      expect(file.preferences['Content-ID']).to match(%r{#{ticket.id}\..+?@devsquest.example.com})
  ...
  >',
    ...
    it 'does ticket split with html - check attachments (05.01)' do
      ...
      article = create(
        ...
        type:         Ticket::Article::Type.lookup(name: 'note'),
        sender:       Ticket::Article::Sender.lookup(name: 'Customer'),
        body:         '<b>test</b> <img src="cid:15.274327094.140938@devsquest.example.com"/> test <img src="cid:15.274327094.140938.3@devsquest.example.com"/>',
        content_type: 'text/html',
        ticket_id:    ticket.id,
      )
      create(:store,
      ...
      create(:store,
             ...
             preferences: {
               'Content-Type'        => 'image/jpeg',
               'Mime-Type'           => 'image/jpeg',
               'Content-ID'          => '15.274327094.140938.2@devsquest.example.com',
               'Content-Disposition' => 'inline',
             })
      create(:store,
             object:      'Ticket::Article',
             ...
             preferences: {
               'Content-Type' => 'image/jpeg',
               'Mime-Type'    => 'image/jpeg',
               'Content-ID'   => '15.274327094.140938.3@devsquest.example.com',
             })
      create(:store,
             object:      'Ticket::Article',
             o_id:        article.id,
             ...
             preferences: {
               'Content-Type' => 'image/jpeg',
               'Mime-Type'    => 'image/jpeg',
               'Content-ID'   => '15.274327094.140938.4@devsquest.example.com',
             })
      create(:store,
             object:      'Ticket::Article',
             o_id:        article.id,
             ...
             preferences: {
               ...
               'Content-ID'          => '8AB0BEC88984EE4EBEF643C79C8E0346@devsquest.example.com',
    ...
    it 'does ticket split with plain - check attachments (05.02)' do
      ...
      article = create(
        ...
        type:         Ticket::Article::Type.lookup(name: 'note'),
        sender:       Ticket::Article::Sender.lookup(name: 'Customer'),
        body:         '<b>test</b> <img src="cid:15.274327094.140938@devsquest.example.com"/>',
  ...
  describe 'stats' do
    ...
    # https://github.com/devsquest/devsquest/issues/2296
