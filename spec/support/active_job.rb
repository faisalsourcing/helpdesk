...
module devsquestActiveJobHelper
...
module devsquestActiveJobSystemHelper
...
RSpec.configure do |config|
  ...
  config.include devsquestActiveJobSystemHelper, performs_jobs: true, type: :system

  activate_for.each do |key, value|
    config.include devsquestActiveJobHelper, key => value
