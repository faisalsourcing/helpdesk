...
RSpec.describe 'Form', type: :system, authenticated_as: true do
  ...
  context 'with in-app form' do
    ...
    context 'when form is inline' do
      let(:form_context) { '.js-formInline form.devsquest-form' }
      let(:name_input) { '#devsquest-form-name-inline' }
      let(:body_input) { '#devsquest-form-body-inline' }
      let(:email_input) { '#devsquest-form-email-inline' }
    ...
    context 'when form is modal' do
      let(:form_context) { '.js-devsquest-form-modal-body form.devsquest-form' }
      let(:name_input) { '#devsquest-form-name-modal' }
      let(:body_input) { '#devsquest-form-body-modal' }
      let(:email_input) { '#devsquest-form-email-modal' }
  ...
  context 'with external form' do
    ...
    let(:form_inline_selector) { '#feedback-form-inline form.devsquest-form' }
