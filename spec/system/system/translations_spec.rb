...
RSpec.describe 'System > Translations', type: :system do
  ...
  context 'when showing a modal dialog that asks for help with translations', authenticated_as: :admin do
    ...
    it 'asks for help with very incomplete translations' do
      visit '/#system/translation'
      expect(page).to have_text('Only 0% of this language is already translated. Please help to improve devsquest and complete the translation.')
    end
    ...
    it 'asks to improve translations with solid coverage' do
      ...
      expect(page).to have_text('Up to 89% of this language is already translated. Please help to make devsquest even better and complete the translation.')
    end
  end
