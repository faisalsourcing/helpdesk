...
RSpec.describe 'Ticket Create', type: :system do
  ...
  describe 'object manager attributes default date', time_zone: 'Europe/London' do
    before :all do # rubocop:disable RSpec/BeforeAfterAll
      ...
      ObjectManager::Attribute.migration_execute # rubocop:disable devsquest/ExistsDbStrategy
    end
  ...
  # https://github.com/devsquest/devsquest/issues/2669
  ...
  # https://github.com/devsquest/devsquest/issues/3825
  ...
  describe 'devsquest 5 mail template double signature #3816', authenticated_as: :authenticate do
