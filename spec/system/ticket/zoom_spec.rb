...
RSpec.describe 'Ticket zoom', type: :system do
  ...
  # https://github.com/devsquest/devsquest/issues/3335
  ...
  # https://github.com/devsquest/devsquest/issues/3012
  ...
  # https://github.com/devsquest/devsquest/issues/3260
  ...
  # https://github.com/devsquest/devsquest/issues/3279
  ...
  # https://github.com/devsquest/devsquest/issues/3267
  ...
  # https://github.com/devsquest/devsquest/issues/2942
  ...
  # https://github.com/devsquest/devsquest/issues/2671
  ...
  describe 'Pending time field in ticket sidebar as agent' do
    ...
    # https://github.com/devsquest/devsquest/issues/3414
    # https://github.com/devsquest/devsquest/issues/2887
  ...
  describe 'GitLab Integration', :integration, authenticated_as: :authenticate, required_envs: %w[GITLAB_ENDPOINT GITLAB_APITOKEN] do
    ...
    it 'creates links and removes them' do
      ...
      within(:active_content) do
        ...
        expect(content).to have_text('devsquest-robot')
