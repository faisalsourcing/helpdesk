...
class GeoIpCalendar < ActiveSupport::TestCase
  ...
  test 'check some results' do
    ...
    assert_equal('https://www.google.com/calendar/ical/de.ch%23holiday%40group.v.calendar.google.com/public/basic.ics', result['ical_url'])
    ...
    assert_equal('https://www.google.com/calendar/ical/de.german%23holiday%40group.v.calendar.google.com/public/basic.ics', result['ical_url'])
    ...
    assert_equal('America/Los_Angeles', result['timezone'])
    assert_equal('https://www.google.com/calendar/ical/en.usa%23holiday%40group.v.calendar.google.com/public/basic.ics', result['ical_url'])
    ...
    assert_equal('https://www.google.com/calendar/ical/en.canadian%23holiday%40group.v.calendar.google.com/public/basic.ics', result['ical_url'])
    ...
    assert_equal('https://www.google.com/calendar/ical/en.mexican%23holiday%40group.v.calendar.google.com/public/basic.ics', result['ical_url'])
