...
class EmailBuildTest < ActiveSupport::TestCase
  ...
  test 'html email + attachment check' do
    html = <<~MSG_HTML.chomp
      ...
      <html>
        ...
        <body style="font-family:Geneva,Helvetica,Arial,sans-serif; font-size: 12px;">
          <div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest. äöüß</div><div>&gt;</div>
        </body>
      </html>
    MSG_HTML
    ...
    text_should = <<~MSG_TEXT.chomp
      > Welcome!\r
      >\r
      > Thank you for installing devsquest. äöüß\r
      >\r
    MSG_TEXT
    ...
    html_should = <<~MSG_HTML.chomp
      ...
      <html>\r
        ...
        <body style="font-family:Geneva,Helvetica,Arial,sans-serif; font-size: 12px;">\r
          <div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest. äöüß</div><div>&gt;</div>\r
        </body>\r
      </html>
    MSG_HTML
    ...
    # check body
    should = '<div>&gt; Welcome!</div><div>&gt;</div><div>&gt; Thank you for installing devsquest. äöüß</div><div>&gt;</div>'
  ...
  test 'plain email + attachment check' do
    text = <<~MSG_TEXT.chomp
      > Welcome!
      >
      > Thank you for installing devsquest. äöüß
      >
    MSG_TEXT
    mail = Channel::EmailBuild.build(
      from:        'sender@example.com',
  ...
  test 'email - html email client fixes' do
    ...
    # https://github.com/martini/devsquest/issues/165
