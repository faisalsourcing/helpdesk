...
Some Text"
    ...
    subject = "some new subject #{SecureRandom.uuid}"
    email_raw_string = "From: mydevsquest@system.test
...
To: ticket-system-sender-customer1@example.com, mydevsquest@system.test
...
Some Text"
    ...
    email_raw_string = "From: ticket-system-sender-agent1@example.com
To: mydevsquest@system.test, ticket-system-sender-customer1@example.com
