...
class NotificationFactoryMailerTest < ActiveSupport::TestCase
  ...
  test 'notifications send' do
    ...
    result = NotificationFactory::Mailer.send(
      recipient:    User.find(2),
      subject:      'some subject',
      body:         'some <span>body</span><img style="width: 85.5px; height: 49.5px" src="cid:15.274327094.140938@devsquest.example.com">asdasd<br>',
      content_type: 'text/html',
    ...
    assert_match('Content-ID: <15.274327094.140938@devsquest.example.com>', result.to_s)
  ...
  test 'notifications settings' do
    ...
    ticket1 = Ticket.create(
      ...
      customer_id:   User.lookup(email: 'nicole.braun@devsquest.org').id,
