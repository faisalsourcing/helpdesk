...
class TicketTest < ActiveSupport::TestCase
  ...
  test 'article attachment helper 1' do
    ...
    article1 = Ticket::Article.create!(
      ...
      body:          'some message article helper test1 <div><img style="width: 85.5px; height: 49.5px" src="cid:15.274327094.140938@devsquest.example.com">asdasd<img src="cid:15.274327094.140939@devsquest.example.com"><br>',
      internal:      false,
      sender:        Ticket::Article::Sender.find_by(name: 'Customer'),
      type:          Ticket::Article::Type.find_by(name: 'email'),
      updated_by_id: 1,
    ...
    store1 = Store.create!(
      ...
      preferences:   {
        ...
        'Content-ID'          => '15.274327094.140938@devsquest.example.com',
    ...
    store2 = Store.create!(
      ...
      preferences:   {
        'Content-Type'        => 'image/jpeg',
        'Mime-Type'           => 'image/jpeg',
        'Content-ID'          => '15.274327094.140939@devsquest.example.com',
        'Content-Disposition' => 'inline'
      },
      created_by_id: 1,
    )
    store3 = Store.create!(
      ...
      preferences:   {
        ...
        'Content-ID'          => '15.274327094.99999@devsquest.example.com',
        'Content-Disposition' => 'inline'
      },
      created_by_id: 1,
    )
    ...
    assert_no_match('15.274327094.140938@devsquest.example.com', article_attributes['body'])
    assert_no_match('15.274327094.140939@devsquest.example.com', article_attributes['body'])
    assert_no_match('15.274327094.99999@devsquest.example.com', article_attributes['body'])
  ...
  test 'article attachment helper 2' do
    ...
    article1 = Ticket::Article.create!(
      ...
      message_id:    'some@id',
      content_type:  'text/html',
      body:          'some message article helper test2 <div><img src="cid:15.274327094.140938@devsquest.example.com">asdasd<img border="0" width="60" height="19" src="cid:15.274327094.140939@devsquest.example.com" alt="Beschreibung: Beschreibung: efqmLogo"><br>',
      internal:      false,
      sender:        Ticket::Article::Sender.find_by(name: 'Customer'),
      type:          Ticket::Article::Type.find_by(name: 'email'),
      updated_by_id: 1,
