...
class TicketTriggerTest < ActiveSupport::TestCase
  ...
  test '1 basic' do
    ...
    ticket1 = Ticket.create!(
      ...
      customer:      User.lookup(email: 'nicole.braun@devsquest.org'),
      updated_by_id: 1,
      created_by_id: 1,
    )
    ...
    assert_match('devsquest <devsquest@localhost>', article1.from)
    assert_match('nicole.braun@devsquest.org', article1.to)
    ...
    assert_match('devsquest <devsquest@localhost>', article3.from)
    assert_match('nicole.braun@devsquest.org', article3.to)
    ...
    assert_match('devsquest <devsquest@localhost>', article4.from)
    assert_match('nicole.braun@devsquest.org', article4.to)
...
<br/>
<p><i><a href="http://devsquest.com">devsquest</a>, your customer support system</i></p>',
          'recipient' => 'ticket_customer',
          'subject'   => 'Thanks for your inquiry (#{ticket.title})',
        },
      },
...
<p><i><a href="http://devsquest.com">devsquest</a>, your customer support system</i></p>',
    ...
    assert_match('devsquest <devsquest@localhost>', article_p.from)
    assert_no_match('config\.', article_p.body)
    assert_match('http://devsquest.example.com', article_p.body)
...
<p><i><a href="http://devsquest.com">devsquest</a>, your customer support system</i></p>',
  ...
  test '6.1 owner auto assignment based on organization' do
    ...
    ticket1.update!(customer: User.lookup(email: 'nicole.braun@devsquest.org'))
  ...
  test '12 notify on owner change' do
    ...
    <br/>
    <div><i><a href="https://devsquest.com">devsquest</a>, your customer support system</i></div>',
          'recipient' => 'ticket_customer',
          'subject'   => 'Thanks for your inquiry (#{ticket.title})',
        },
      },
  ...
  test 'article_last_sender trigger -> reply_to' do
    ...
    assert_match('devsquest <devsquest@localhost>', auto_response.from)
  ...
  test '2 loop check' do
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[3].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[5].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[7].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[9].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[11].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[13].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[15].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[17].to)
    ...
    assert_equal('nicole.braun@devsquest.org', ticket1.articles[19].to)
  ...
  test 'make sure attachments should be attached with content id' do
    ...
    assert_match('smith@example.com', article1.to)
    assert_match('Thanks for your inquiry (aaäöüßad asd)!', article1.subject)
    assert_match(%r{.+cid:.+?@devsquest.example.com.+}, article1.body)
  ...
  test 'NOT IN predicates handle NULL values' do
    customer = User.create!(
      email:         'issue_1316_test_user@devsquest.org',
      created_by_id: 1,
      updated_by_id: 1,
    )
    ...
    assert_equal('devsquest <devsquest@localhost>', autoreply.from)
  ...
  test 'trigger note and auto responder (correct order) when there is an article body contains matched values' do
    ...
    assert_match('devsquest <devsquest@localhost>', article_auto_responder1.from)
    assert_match('nicole.braun@devsquest.org', article_auto_responder1.to)
