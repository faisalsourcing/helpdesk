...
class UserTest < ActiveSupport::TestCase
  test 'user' do
    ...
    default_disable_in_test_env = Service::Image::devsquest.const_get(:DISABLE_IN_TEST_ENV)
    Service::Image::devsquest.const_set(:DISABLE_IN_TEST_ENV, false)
    ...
    Service::Image::devsquest.const_set(:DISABLE_IN_TEST_ENV, default_disable_in_test_env)
  end
